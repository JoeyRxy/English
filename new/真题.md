...
- **render**:使成为，导致；提供；呈现 ($\colorbox{yellow}{IMPORTANT}$
...
## Part C $\colorbox{yellow}{IMPORTANT}$

- distinguish
- $\colorbox{yellow}{IMPORTANT}$ : He did not accept as well founded the charge made by some of his critics that, while he was a good observer, he had no power of reasoning.
